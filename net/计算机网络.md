...
3. <mark>同步(时序)：事件实现的顺序和时间的详细说明</mark>（数据何时发出以及以什么速率发出）

#### 1.6.2 分层体系结构 ⭐⭐

> OSI体系结构从下到上：物链网输会示用 -> <span alt='highlight'>物联网叔会使用</span>
...
4. <mark>截断二进制指数退避算法</mark>：发生碰撞后进行重传，随着重传次数增加，退避时间也会逐渐增加，减小了碰撞的概率

![a2087c67a9552b2d56da2809ce24d946](https://s2.loli.net/2024/12/11/c96uKpfFP2C3Loi.png)
...
>  [!important] 
>
>  1.IPv6将地址从32位(4B)扩大到**128位(16B)**，更大的地址空间(IPv4的$2^{96}$倍)。
